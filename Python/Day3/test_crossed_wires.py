...
simple_grid_size = 5
simple_oversize_multiplier = 4
simple_test_vector = Vector(Direction.DOWN, 4)
simple_test_grid = Grid(simple_grid_size, simple_oversize_multiplier)
...
def test_calculate_range():
    ...
    assert(vec.calculate_vector_range(simple_test_grid.origin) == range(1, 6, 1))


def test_get_array_coordinates():
    assert(simple_test_grid.get_array_coord_for_coord(simple_test_grid.origin) ==
           (simple_grid_size*simple_oversize_multiplier, simple_grid_size*simple_oversize_multiplier))


def test_marking_line():
    simple_test_grid.mark_vector(Vector(Direction.UP, 3), simple_test_grid.origin, 0)
