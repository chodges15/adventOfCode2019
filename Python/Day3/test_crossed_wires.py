...
def test_example_2():
    ...
    print([intersection for intersection in cw.get_intersections()])
    assert (min([CrossedWires.manhattan_distance(cw.grid.origin, intersection) for intersection in
                 cw.get_intersections()]) == 159)
...
def test_example_3():
    ...
    print([intersection for intersection in cw.get_intersections()])
    assert(min([CrossedWires.manhattan_distance(cw.grid.origin, intersection) for intersection in cw.get_intersections()]) == 135)
...
def test_problem_part_1():
    ...
    print([intersection for intersection in cw.get_intersections()])
    assert (min(
        [CrossedWires.manhattan_distance(cw.grid.origin, intersection) for intersection in cw.get_intersections()]) == 5319)
